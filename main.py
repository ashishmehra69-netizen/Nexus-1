...
def get_analytics_summary():
    ...
    summary = f"""# 📊 NEXUS Analytics Dashboard
...
✓ What You Will Walk Away With (3+ outcomes)
✓ Tools & Templates section (3 templates)
✓ Find Templates Online (3 Google searches)
✓ Patterns We See / Myths vs Reality
✓ The Core Frameworks (Framework in Action with detailed steps)
✓ See It in Action: Real Example
✓ Your Turn: Practice Exercise
✓ Resources to Go Deeper (3 videos - MANDATORY)
✓ Group Dialogue (Opening + Closing questions)
✓ One Bold Closing Thought
...
You begin by listing 8-12 factors that truly define how companies compete in your industry. This isn't about what you think matters—it's about what customers actually care about and what competitors emphasize. You're looking for the complete picture of the competitive landscape.
...
Now you rate yourself and 2-3 key competitors on each factor using a 1-10 scale. This creates visual lines on a graph that show where everyone is positioned. The goal is to see clustering—where everyone competes the same way.
...
- **Example:** If all consultants cluster around "high expertise (8-9), high price (8-9), slow delivery (3-4)"—that's red ocean competition
- **Common Mistake:** Rating based on internal beliefs rather than customer perception
- **Pro Tip:** Have customers rate you and competitors—their perception is your reality
...
- **Action:** For ELIMINATE—Which factors does the industry take for granted that you could remove completely? (Example: Fancy offices, lengthy proposals)
- **Action:** For REDUCE—Which factors should you reduce well below industry standard? (Example: Meeting frequency, formality)
- **Action:** For RAISE—Which factors should you raise well above industry standard? (Example: Results transparency, speed)
- **Action:** For CREATE—What should you create that's never been offered? (Example: Success-based pricing, real-time dashboards)
...
- **Pro Tip:** The most powerful moves are in ELIMINATE and CREATE—that's where differentiation lives

**Step 4: DRAW - Design Your New Strategic Canvas**

Finally, you sketch your new competitive curve showing your repositioned organization. This curve should look distinctly different from competitors—not just better on the same factors, but different in shape entirely.

- **Action:** Sketch what your new curve looks like—which factors are now 0, which are 10, which are 5
- **Action:** Compare to competitor curves—yours should have a unique shape, not just higher/lower
...
- **Common Mistake:** Creating a curve that's just slightly different—bold differentiation requires obvious visual difference
- **Pro Tip:** If your curve looks like everyone else's but "better"—you're still in red ocean
...
3. Apply ERRC Grid: What will you eliminate, reduce, raise, create? Be bold—safe answers don't differentiate
